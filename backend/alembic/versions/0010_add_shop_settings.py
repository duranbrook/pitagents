...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("mitchell1_enabled", sa.Boolean(), nullable=True),
        sa.Column("mitchell1_api_key_encrypted", sa.Text(), nullable=True),
        sa.Column("synchrony_enabled", sa.Boolean(), nullable=True),
        sa.Column("synchrony_dealer_id", sa.String(length=100), nullable=True),
        sa.Column("wisetack_enabled", sa.Boolean(), nullable=True),
        sa.Column("wisetack_merchant_id", sa.String(length=100), nullable=True),
        sa.Column("quickbooks_enabled", sa.Boolean(), nullable=True),
